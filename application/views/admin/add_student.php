...
<body>
    <div class="sidebar">
        <h1><strong>Add Student Details</strong> </h1>
    ...
    <div class="container">
    <?php echo form_open_multipart('admin/save_student'); ?>
...
<input type="radio" name="gender" value="Male" class="form-check-input" <?php echo set_radio('gender', 'Male'); ?>>
<label class="form-check-label">Male</label>
</div>
<div class="form-check">
<input type="radio" name="gender" value="Female" class="form-check-input" <?php echo set_radio('gender', 'Female'); ?>>
